...
final class Version20201112051221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category_reference ADD CONSTRAINT FK_69C39B239C24126 FOREIGN KEY (day_id) REFERENCES day (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category_reference DROP FOREIGN KEY FK_69C39B239C24126');
